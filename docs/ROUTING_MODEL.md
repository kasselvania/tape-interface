...
| P2 | Same, USB Playback L then R; Line Input disconnected | PRELIMINARY: operator reports "nope. I see nothing" during requested USB Playback with ZERO / Monitor Flag OFF. No visible response reported; host output activity/port assignment, individual meter readbacks and headphone audibility unconfirmed. L/R isolation and disconnected Line Input NOT TESTED. No routing-edge conclusion. |
